...
function print_aside_menu()
{
	$aside_menu = wp_nav_menu( array(
			...
			'container'       => 'nav',
			'container_class' => 'navbar navbar-toggleable-sm navbar-light',
			'container_id'    => 'aside-menu-container',
			'menu_class'      => 'left-menu',
			'fallback_cb'     => 'wp_page_menu',
			'items_wrap'      => '<button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">

...
<footer>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p><small>Представленная на сайте информация, касающаяся комплектации отопительного оборудования, носит информационный характер. При размещении заказа на запасные части просим уточнить комплектацию у консультанта по технической поддержке.</small></p>
          <p class="copy"><small>&copy; 2016 – <?=date('Y')?>. ГК ЭЛЕКТРОПОМПА. Все права защищены.</small></p>
        </div>
      </div>
    </div>
